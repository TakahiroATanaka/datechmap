...
export const TechnologyMapCatalogList: React.FC = () => {
  return (
    <ul>
      ...
      <li>
        <Anchor href="https://www.digital.go.jp/policies/digital-extraordinary-administrative-research-committee/regtechmap/wide-area-inspection">
          広域な利用状況把握・被害等の把握のデジタル化を実現する製品・サービス一覧
        </Anchor>
      </li>
      <li>
        <Anchor href="https://www.digital.go.jp/policies/digital-extraordinary-administrative-research-committee/regtechmap/field-audit">
