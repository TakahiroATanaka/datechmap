  ...
  return (
    <div className="flex flex-col gap-12">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-4">
        <LinkButton path="/procurement/#public_notice">入札公告等</LinkButton>
        <LinkButton path="/procurement/#proposal">企画競争情報</LinkButton>
        <LinkButton path="/procurement/#public_tender">公募情報</LinkButton>
        <LinkButton path="/procurement/#rfc_answer">意見招請情報</LinkButton>
      </div>
