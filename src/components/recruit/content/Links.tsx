  ...
  return (
    <div className="flex flex-col gap-8">
      <section className="flex flex-col gap-4">
        <h3 className="text-web-xs">業務説明会・イベント</h3>
        <UnstyledAnchor
          className="rounded-2xl border border-divider px-6 py-4 text-button leading-[22px] transition-all duration-200 hover:bg-sumi-50 active:bg-sumi-50"
      ...
      <section className="flex flex-col gap-4">
        <h3 className="text-web-xs">新卒採用</h3>
        <UnstyledAnchor
          className="rounded-2xl border border-divider px-6 py-4 text-button leading-[22px] transition-all duration-200 hover:bg-sumi-50 active:bg-sumi-50"
      ...
      <section className="flex flex-col gap-4">
        <h3 className="text-web-xs">中途採用</h3>
        <UnstyledAnchor
          className="rounded-2xl border border-divider px-6 py-4 text-button leading-[22px] transition-all duration-200 hover:bg-sumi-50 active:bg-sumi-50"
